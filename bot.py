...
def mainbotstart():
    ...
    # SLASH: /play [query]
    # ----------------------------
    @bot.tree.command(name="play", description="Запуск песни по URL или названию с ютуба (CUSTOMPLAY only)")
    ...
    # SLASH: /stop
    # ----------------------------
    @bot.tree.command(name="stop", description="Остоновка песни (CUSTOMPLAY only)")
    ...
    # SLASH: /skip
    # ----------------------------
    @bot.tree.command(name="skip", description="Пропуск песни (CUSTOMPLAY only)")
