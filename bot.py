...
GEMINI_SYSTEM_PROMPT = (
    "Вы — полезный, вежливый и информативный ассистент. Отвечайте на любые вопросы пользователя полно, прямо и по существу. "
    ...
    "ВАЖНО: Ограничивайте ваш ответ максимум 1900 символами. Если ответ требует больше — сокращайте, суммируйте или убирайте мало важное продолжение. "
...
def ask_gemini(msg: str) -> str:
    ...
    Ответ обрезается после 1950 символов для соответствия ограничениям Discord.
    """
    full_prompt = (
    ...
    # Обрезаем ответ до 1950 символов
    if len(text) > 1950:
        text = text[:1950]
